/**
 * Script to verify Dr. Carlos Tahuil-Ochoa's appointment data in the database
 */
...
async function verifyAppointments() {
  console.log('🔍 Verifying Dr. Carlos Tahuil-Ochoa\'s appointments in database...\n');
  ...
  console.log('═══════════════════════════════════════════════════════════');
  console.log('✅ VERIFIED: Dr. Carlos Tahuil-Ochoa Appointments in Database');
  console.log('═══════════════════════════════════════════════════════════');
