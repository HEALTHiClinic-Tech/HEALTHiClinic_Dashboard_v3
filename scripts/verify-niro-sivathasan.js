/**
 * Script to verify Dr. Niro Sivathasan's appointment data in the database
 */
...
async function verifyAppointments() {
  console.log('🔍 Verifying Dr. Niro Sivathasan\'s appointments in database...\n');
  ...
  console.log('═══════════════════════════════════════════════════════════');
  console.log('✅ VERIFIED: Dr. Niro Sivathasan Appointments in Database');
  console.log('═══════════════════════════════════════════════════════════');
