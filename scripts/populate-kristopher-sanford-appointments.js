/**
 * Script to populate Dr. Kristopher Sanford's weekly appointment data
 *
 * Usage: node scripts/populate-kristopher-sanford-appointments.js
 *
...
// Dr. Kristopher Sanford's appointment data extracted from screenshots
const appointmentData = [
  { weekStart: '2025-10-27', year: 2025, weekNumber: 44, appointments: 2 },   // Oct 27 - Nov 2
  ...
  { weekStart: '2025-11-24', year: 2025, weekNumber: 48, appointments: 2 },   // Nov 24 - Nov 30
  { weekStart: '2025-12-01', year: 2025, weekNumber: 49, appointments: 4 },   // Dec 1 - Dec 7
  { weekStart: '2025-12-08', year: 2025, weekNumber: 50, appointments: 2 },   // Dec 8 - Dec 14
  { weekStart: '2025-12-15', year: 2025, weekNumber: 51, appointments: 6 },   // Dec 15 - Dec 21
  ...
  { weekStart: '2026-01-12', year: 2026, weekNumber: 3, appointments: 2 },    // Jan 12 - Jan 18
  { weekStart: '2026-01-19', year: 2026, weekNumber: 4, appointments: 3 },    // Jan 19 - Jan 25
  { weekStart: '2026-01-26', year: 2026, weekNumber: 5, appointments: 0 },    // Jan 26 - Feb 1
  { weekStart: '2026-02-02', year: 2026, weekNumber: 6, appointments: 1 },    // Feb 2 - Feb 8
  { weekStart: '2026-02-09', year: 2026, weekNumber: 7, appointments: 0 },    // Feb 9 - Feb 15
  { weekStart: '2026-02-16', year: 2026, weekNumber: 8, appointments: 4 },    // Feb 16 - Feb 22
  ...
  { weekStart: '2026-03-23', year: 2026, weekNumber: 13, appointments: 2 },   // Mar 23 - Mar 29
  { weekStart: '2026-03-30', year: 2026, weekNumber: 14, appointments: 1 },   // Mar 30 - Apr 5
];

async function populateAppointments() {
  console.log('🔍 Looking for Dr. Kristopher Sanford in the database...\n');

  // Step 1: Find Dr. Kristopher Sanford's ID
  const { data: doctors, error: doctorError } = await supabase
    .from('doctors')
    .select('*')
    .eq('first_name', 'Kristopher')
    .eq('last_name', 'Sanford');
  ...
  if (!doctors || doctors.length === 0) {
    console.error('❌ Dr. Kristopher Sanford not found in the database.');
    console.log('Please make sure the doctor exists in the doctors table.');
    process.exit(1);
  }

  const doctor = doctors[0];
  console.log(`✅ Found Dr. Kristopher Sanford!`);
  ...
  console.log('═══════════════════════════════════════════════════════════');
  console.log('📋 SUMMARY - Dr. Kristopher Sanford Appointments');
  console.log('═══════════════════════════════════════════════════════════');
