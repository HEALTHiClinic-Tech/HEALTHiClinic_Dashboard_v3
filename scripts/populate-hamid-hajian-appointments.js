/**
 * Script to populate Dr. Hamid Hajian's weekly appointment data
 *
 * Usage: node scripts/populate-hamid-hajian-appointments.js
 *
...
// Dr. Hamid Hajian's appointment data extracted from screenshots
const appointmentData = [
  { weekStart: '2025-10-27', year: 2025, weekNumber: 44, appointments: 1 },   // Oct 27 - Nov 2
  { weekStart: '2025-11-03', year: 2025, weekNumber: 45, appointments: 8 },   // Nov 3 - Nov 9
  { weekStart: '2025-11-10', year: 2025, weekNumber: 46, appointments: 3 },   // Nov 10 - Nov 16
  { weekStart: '2025-11-17', year: 2025, weekNumber: 47, appointments: 9 },   // Nov 17 - Nov 23
  { weekStart: '2025-11-24', year: 2025, weekNumber: 48, appointments: 4 },   // Nov 24 - Nov 30
  { weekStart: '2025-12-01', year: 2025, weekNumber: 49, appointments: 5 },   // Dec 1 - Dec 7
  { weekStart: '2025-12-08', year: 2025, weekNumber: 50, appointments: 6 },   // Dec 8 - Dec 14
  { weekStart: '2025-12-15', year: 2025, weekNumber: 51, appointments: 7 },   // Dec 15 - Dec 21
  ...
  { weekStart: '2026-01-12', year: 2026, weekNumber: 3, appointments: 5 },    // Jan 12 - Jan 18
  { weekStart: '2026-01-19', year: 2026, weekNumber: 4, appointments: 5 },    // Jan 19 - Jan 25
  { weekStart: '2026-01-26', year: 2026, weekNumber: 5, appointments: 0 },    // Jan 26 - Feb 1
  { weekStart: '2026-02-02', year: 2026, weekNumber: 6, appointments: 7 },    // Feb 2 - Feb 8
  { weekStart: '2026-02-09', year: 2026, weekNumber: 7, appointments: 5 },    // Feb 9 - Feb 15
  { weekStart: '2026-02-16', year: 2026, weekNumber: 8, appointments: 6 },    // Feb 16 - Feb 22
  { weekStart: '2026-02-23', year: 2026, weekNumber: 9, appointments: 0 },    // Feb 23 - Mar 1
  { weekStart: '2026-03-02', year: 2026, weekNumber: 10, appointments: 7 },   // Mar 2 - Mar 8
  { weekStart: '2026-03-09', year: 2026, weekNumber: 11, appointments: 4 },   // Mar 9 - Mar 15
  { weekStart: '2026-03-16', year: 2026, weekNumber: 12, appointments: 3 },   // Mar 16 - Mar 22
  { weekStart: '2026-03-23', year: 2026, weekNumber: 13, appointments: 4 },   // Mar 23 - Mar 29
  { weekStart: '2026-03-30', year: 2026, weekNumber: 14, appointments: 8 },   // Mar 30 - Apr 5
];

async function populateAppointments() {
  console.log('🔍 Looking for Dr. Hamid Hajian in the database...\n');

  // Step 1: Find Dr. Hamid Hajian's ID
  ...
  if (!doctors || doctors.length === 0) {
    console.error('❌ Dr. Hamid Hajian not found in the database.');
    process.exit(1);
  }

  const doctor = doctors[0];
  console.log(`✅ Found Dr. Hamid Hajian!`);
  ...
  console.log('═══════════════════════════════════════════════════════════');
  console.log('📋 SUMMARY - Dr. Hamid Hajian Appointments');
  console.log('═══════════════════════════════════════════════════════════');

  let totalAppointments = 0;
  const target = doctor.weekly_target || 8;
